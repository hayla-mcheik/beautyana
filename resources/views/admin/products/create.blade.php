        ...
        <form action="{{ url('admin/products') }}" method="POST" enctype="multipart/form-data" id="productForm">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white">
                    <h5 class="mb-1">
                        <i class="mdi mdi-information-outline"></i> Product Information
                    </h5>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Example: Diamond Tennis Bracelet" required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="description" rows="6" class="form-control @error('description') is-invalid @enderror" placeholder="Enter product material, design, size, collection information and other useful details...">{{ old('description') }}</textarea>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white">
                    <h5 class="mb-1">
                        <i class="mdi mdi-cash-multiple"></i> Pricing & Inventory
                    </h5>
                    <small class="text-muted">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" name="original_price" value="{{ old('original_price') }}" class="form-control @error('original_price') is-invalid @enderror" placeholder="0.00">
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">$</span>
                                <input type="number" step="0.01" min="0" name="selling_price" value="{{ old('selling_price') }}" class="form-control @error('selling_price') is-invalid @enderror" placeholder="0.00">
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" min="0" name="quantity" value="{{ old('quantity', 0) }}" class="form-control @error('quantity') is-invalid @enderror">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white">
                    <h5 class="mb-1">
                        <i class="mdi mdi-eye-outline"></i> Product Visibility
                    </h5>
                    <small class="text-muted">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-1">
                                <i class="mdi mdi-image-multiple-outline"></i> Product Images
                            </h5>
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <div class="mt-1">
                            Upload at least one image. The first selected image will be used as the primary product image.
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between">
                            <small>Minimum image requirement</small>
                            <small id="imageRequirementText">0 / 1</small>
                        </div>
                        <div class="progress mt-2" style="height: 8px;">
                            <div id="imageProgressBar" class="progress-bar" style="width: 0%;"></div>
                        </div>
                    </div>

                    {{-- IMAGE MESSAGE --}}
                    <div id="imageRequirements" class="alert alert-warning mt-3">
                        <i class="mdi mdi-alert-outline"></i>
                        <span id="requirementMessage">Please select at least one image.</span>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const imageRequirementText = document.getElementById('imageRequirementText');
    ...
    function updateImageCount() {
        ...
        imageRequirementText.textContent = Math.min(count, 1) + ' / 1';

        const progress = Math.min((count / 1) * 100, 100);
        ...
        if (count < 1) {
            ...
            requirementMessage.textContent = 'Please select at least one image.';
                ...
                column.innerHTML = `
                    <div class="card product-image-card h-100">
                        <div class="position-relative">
                            <img src="${event.target.result}" class="card-img-top" alt="Product Preview">
                            <span class="badge bg-primary position-absolute top-0 start-0 m-2">
                                ${index === 0 ? 'Primary Image' : 'Image ' + (index + 1)}
                            </span>
                            <button type="button" class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2 remove-image-btn" data-index="${index}">
    ...
    productImages.addEventListener('change', function () {
        ...
        newFiles.forEach(newFile => {
            const alreadyExists = allSelectedFiles.some(
        ...
        if (allSelectedFiles.length < 1) {
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    ...
                    text: 'Please upload at least one product image before saving the product.',
                    confirmButtonText: 'OK'
                });
            } else {
                alert('Please upload at least one product image before saving.');
            }
            document.querySelector('.product-upload-area').scrollIntoView({
                behavior: 'smooth',
                block: 'center'
            });
        }
